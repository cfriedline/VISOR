...
def main():
    ...
    required.add_argument(
        "-g",
        "--genome",
        help="Template reference genome",
        metavar="FASTA",
        required=True,
    )
    required.add_argument(
    ...
    simtype.add_argument(
        "-t",
        "--type",
        help="Whether to simulate bulk [bulk] or strand-seq [strand-seq] data [bulk]",
        metavar="",
        default="bulk",
    ...
    wgi.add_argument(
        "-c",
        "--coverage",
        help="Mean coverage for the simulated region [30.0]",
        metavar="",
        default=30.0,
        type=float,
    )
    ...
    wgi.add_argument(
        "-i",
        "--indels",
        help="Fractions of indels [0.000000001]",
        metavar="",
        default=0.000000001,
        type=float,
    )
    wgi.add_argument(
        "-p",
        "--probability",
        help="Probability an indel is extended [0.000000001]",
        metavar="",
        default=0.000000001,
        type=float,
    )
    wgi.add_argument(
        "-is",
        "--insertsize",
        help="0uter distance between the two ends [500]",
        metavar="",
        default=500,
        type=int,
    )
    wgi.add_argument(
        "-sd",
        "--standardev",
        help="Standard deviation for insert size [50]",
        metavar="",
        default=50,
        type=int,
    )
    ...
    strandseq.add_argument(
        "--noise",
        help="Percentage of noise to add to strand-seq BAM files [0.00]",
        type=float,
        metavar="",
        default=0.00,
    )
    ...
    optional.add_argument(
        "--identifier",
        help="Identifier to label the output [sim]",
        metavar="",
        default="sim",
    )
    optional.add_argument(
    ...
    pbs.add_argument(
        "-c",
        "--coverage",
        help="Mean coverage for the simulated region [20]",
        metavar="",
        default=20.0,
        type=float,
    )
    pbs.add_argument(
        "-a",
        "--accuracy",
        help="Mean accuracy for simulated reads [0.90]",
        metavar="",
        default=0.90,
        type=float,
    )
    pbs.add_argument(
        "-l",
        "--length",
        help="Mean length for simulated reads [8000]",
        metavar="",
        default=8000,
        type=int,
    )
    pbs.add_argument(
        "-r",
        "--ratio",
        help="substitution:insertion:deletion ratio [30:30:40]",
        metavar="",
        default="30:30:40",
        type=str,
    )
    ...
    optional.add_argument(
        "--noaddtag",
        help="Do not tag reads in BAM by haplotype and clone number",
        action="store_false",
    )
    optional.add_argument(
        "--addprefix",
    ...
    required.add_argument(
        "-s",
        "--sample",
        help="A folder containing FASTA haplotypes with SVs generated with VISOR HACk",
        metavar="FOLDER",
        required=True,
    )
    required.add_argument(
    ...
    molecules.add_argument(
        "--molecules_number",
        help="Mean number of molecules per GEM [10]",
        default=10,
        type=int,
        metavar="",
    )
    molecules.add_argument(
        "--molecules_coverage",
        help="Mean coverage per molecule [0.2]",
        default=0.2,
        type=float,
        metavar="",
    )
